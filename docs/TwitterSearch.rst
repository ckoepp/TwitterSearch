...
----------------------------------------------- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ ----------------------------------------------------------------------------------------------------------------
``sentSearch(<string>, quick=True)``            Queries the Twitter Search API with a given query string, determines if there are more results available in API and returns response.                                                                                                                          ``sentSearch('?q=One+Two&count=100')``
----------------------------------------------- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ ----------------------------------------------------------------------------------------------------------------
